<div class="row">
                ...
                <div class="card-header py-3 bg-transparent"> 
                    ...
                    <h5 class="mb-2 mb-sm-0">Danh sách mẫu mail gửi cho Khách hàng</h5>
                    </div>
                    </div>
                    <?php 
                ...
                <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            $start_from = ($page-1) * $per_page_record;     
                                $result = mysqli_query($conn,"SELECT * FROM template_mail WHERE role='0' ORDER BY name ASC LIMIT $start_from, $per_page_record ");
                                $index = 1;
                    ...
                    <?php
                        ...
                        $resultCount = mysqli_query($conn,"SELECT count(*) FROM template_mail WHERE role='0'");
                        $rowPagination = mysqli_fetch_row($resultCount);
                        $total = $rowPagination[0];
                        pagination($total, $per_page_record, './gmail-admin.php', $page, "pageGuest");
